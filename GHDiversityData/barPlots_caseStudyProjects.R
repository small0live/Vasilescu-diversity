...
#lang <- lang[c(1:3,5:11,4),]

lang$language <- factor(lang$language, levels = lang$language)

png(filename="barPlots_caseStudyProjects_Language.png",
...
contributors <- contributors[c(3,5,6,1,2,4),]

contributors$contributors <- factor(contributors$contributors, levels = contributors$contributors)

png(filename="barPlots_caseStudyProjects_12moContributors.png",
    width=1500, height=1000,
    units="px", res=330)
ggplot(contributors, 
...
commits <- commits[c(1,3,4,5,2),]

commits$commits <- factor(commits$commits, levels = commits$commits)

png(filename="barPlots_caseStudyProjects_12moCommits.png",
    width=1500, height=1000,
    units="px", res=330)
ggplot(commits, 
       aes(x = commits,
...
forks <- forks[c(1,6,2,3,4,5),]

forks$num_forks <- factor(forks$num_forks, levels = forks$num_forks)

png(filename="barPlots_caseStudyProjects_Forks.png",
    width=1500, height=1000,
    units="px", res=330)
ggplot(forks, 
       aes(x = num_forks,
...
png(filename="barPlots_caseStudyProjects_Watchers.png",
    width=1500, height=1000,
    units="px", res=330)
ggplot(watchers, 
       aes(x = num_watch,
...
png(filename="barPlots_caseStudyProjects_Age.png",
    width=1500, height=1000,
    units="px", res=330)
ggplot(projectAge, 
       aes(x = project_age,
